...
const CLUB_FIELD = { Watford: 'Watford', QPR: 'Queens Park Rangers', SheffUtd: 'Sheffield United', Blackburn: 'Blackburn Rovers', WestBrom: 'West Brom', Middlesbrough: 'Middlesbrough', Barcelona: 'Barcelona', Chelsea: 'Chelsea', Celtic: 'Celtic', 'Leeds United': 'Leeds United', Besiktas: 'Besiktas', Juventus: 'Juventus', 'Paris Saint-Germain': 'Paris Saint-Germain', Napoli: 'Napoli' };
