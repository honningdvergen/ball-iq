...
const CLUB_FIELD = { Middlesbrough: 'Middlesbrough', Barcelona: 'Barcelona', Chelsea: 'Chelsea', Celtic: 'Celtic', 'Leeds United': 'Leeds United', Besiktas: 'Besiktas', Juventus: 'Juventus', 'Paris Saint-Germain': 'Paris Saint-Germain', Napoli: 'Napoli' };
