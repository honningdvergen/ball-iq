...
export const NATIONS = [
  {
    ...
    "intro": [
      ...
      "Every question comes with a short, explained answer, so you finish each round knowing why 1966 still stands alone, how the penalty ghosts of Turin, Wembley and Berlin piled up, and exactly where this young generation fits in the story. And the story just got a new chapter: at the 2026 World Cup across the United States, Canada and Mexico, Thomas Tuchel's England went out to Argentina in the semi-finals and then won a remarkable third-place play-off 6-4 against France, Bukayo Saka scoring a hat-trick — their best finish at a World Cup since they won it in 1966. Play the sample set below free in your browser: no sign-up, no download, just tap and go. And when you want more — thousands of questions spanning the World Cup, the Premier League and European football, plus a daily football word game and live multiplayer matches against your mates — it's all waiting in the free Ball IQ app."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample England quiz below free in your browser, with no sign-up and no download. For the full experience — thousands of questions, a daily football word game and multiplayer — download the free Ball IQ app on iOS or Android."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short, explained answer, so each round teaches you something — why Carlos Alberto's goal capped the perfect team move, or how the 1994 shoot-out actually unfolded. You can play the sample set below free in your browser, no sign-up required. When you want more — thousands of questions spanning World Cups, the Copa América, clubs and legends, plus Footle, a daily football word game, and live multiplayer against your friends — it's all free in your browser at balliq.app/play — or in the Ball IQ app. With the 2026 World Cup under way across the USA, Canada and Mexico, and Carlo Ancelotti's Brazil chasing an overdue sixth star behind Vinícius Júnior, there has never been a better time to test how much you really know about the Seleção."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Brazil questions on this page free in your browser with no sign-up. For the full experience — thousands of questions, the daily Footle word game and live multiplayer — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so even a miss leaves you knowing more — why 1986 still defines the rivalry with England, or how Messi's redemption arc finally closed in Qatar. And it lands at the perfect moment: Argentina went to the 2026 World Cup, co-hosted by the United States, Canada and Mexico, as reigning champions with Messi still leading them, and came within one goal of keeping the trophy — beaten 1-0 by Spain in extra time in the final at MetLife Stadium. Play the sample set below free in your browser, no sign-up. When you want more — thousands of questions, a daily word game and multiplayer — it's all free in your browser at balliq.app/play — or in the Ball IQ app."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes — the sample questions are free in your browser with no sign-up, and the full Ball IQ app has thousands of football questions plus a daily word game and multiplayer."
      }
    ]
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short, explained answer, so you're not just testing what you know — you're picking up the context behind each result, each record and each famous night. Play the sample set below free in your browser, no sign-up required. When you want more — thousands of questions spanning the World Cup, the Euros, club football and the greats, plus a daily football word game and live multiplayer against friends — it's all free in your browser at balliq.app/play — or in the Ball IQ app. Whether you grew up on Zidane's volleys or you've only ever known the Mbappé era, there's a level here for you, from gentle warm-ups to questions that will test even a lifelong follower of Les Bleus. Start with the free set and see how deep your France knowledge really runs."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample set of France questions free right here in your browser, with no sign-up. For the full experience — thousands of questions, a daily football word game and live multiplayer — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Germany quiz right here in your browser with no sign-up and no payment. For the full experience — thousands of questions, a daily football word game and multiplayer — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Spain quiz right here in your browser with no sign-up. For the full experience — thousands of questions, a daily football word game and multiplayer modes — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Italy quiz right here in your browser, free and with no sign-up. For the full experience — thousands of questions, a daily football word game and live multiplayer — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so even a miss teaches you the detail that makes it stick — why Éder, of all people, became a national hero, or how Ronaldo overtook Eusébio as Portugal's all-time World Cup scorer. And with Portugal having arrived at the 2026 World Cup as reigning Nations League champions, Ronaldo past his 41st birthday and chasing the one prize that has eluded him, there has never been a better moment to test what you know. Play the sample set below free in your browser, no sign-up. When you want more football trivia — thousands of questions, a daily word game and multiplayer — it's all free in your browser at balliq.app/play — or in the Ball IQ app."
    ],
    "faq": [
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample set of Netherlands questions right here in your browser, free and with no sign-up. For the full experience — thousands of questions across every nation, club and competition, plus a daily football word game and multiplayer modes — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample USA questions right here in your browser, free and with no sign-up. For the full experience — thousands of questions, a daily football word game and multiplayer matches — download the Ball IQ app on iOS or Android."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Mexico set right here in your browser, free and with no sign-up. For the full experience — thousands of questions, a daily word game and multiplayer — download the free Ball IQ app."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short, explained answer, so you don't just score a point — you learn the story behind the scoreline. Why the Maracanazo still stings in Rio, why those four stars sit above the crest, when Uruguay last lifted the Copa América, and how a nation so small stayed so fearsome for a hundred years. Play the sample set below free in your browser — no sign-up, no download, just tap and go. When you want more, the full Ball IQ app packs thousands of questions spanning clubs, countries and competitions, a daily football word game to keep your streak alive, and live multiplayer to settle once and for all who really knows La Celeste best."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. You can play the sample Uruguay questions right here in your browser, completely free and with no sign-up. For the full experience — thousands of questions, a daily football word game and live multiplayer — download the free Ball IQ app on iOS and Android."
      },
      {
