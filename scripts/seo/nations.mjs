...
export const NATIONS = [
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short, explained answer, so you're not just testing what you know — you're picking up the context behind each fact, from why 2010 mattered to how the tiki-taka era reshaped the game. Play the sample set below free in your browser, no sign-up required. When you want more — thousands of questions spanning every nation, club and competition, a daily football word game, and multiplayer modes to test friends in real time — it's all in the Ball IQ app. Whether you lived through Iniesta's winner or you're discovering Lamine Yamal for the first time, there's a level here for every kind of Spain fan, from the casual supporter to the encyclopedia who still remembers Marcelino in 1964."
    ],
    "faq": [
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you're not just testing what you know — you're learning the story behind each result, record and famous night. Play the sample set below free in your browser, no sign-up needed. When you want more — thousands of questions spanning every nation, club and competition, plus a daily football word game and multiplayer modes to challenge your friends — it's all in the Ball IQ app. Whether you lived through the 1988 volley or you're discovering the Oranje through Gakpo and Van Dijk, there's a level of difficulty here for every kind of Dutch football fan. Start with the free questions below, see how your Ball IQ stacks up, and then dive into the full experience."
    ],
    "faq": [
      {
