...
export const PLAYERS = [
  {
    ...
    faq: [
      ...
      { q: 'Is the Ronaldo quiz free to play?', a: 'Yes — the sample questions are free in your browser with no sign-up, and the full Ball IQ app has thousands of football questions plus daily challenges and multiplayer.' },
  ...
  },
  {
    ...
    intro: [
      ...
      "Every question comes with a short explained answer, so even a miss leaves you knowing more — why 2022 meant everything, or how a napkin became folklore. Play the sample set below free in your browser, no sign-up. When you want more — thousands of questions, a daily word game and multiplayer — it lives in the Ball IQ app.",
    ],
    faq: [
      ...
      { q: 'Is the Messi quiz free to play?', a: 'Yes — the sample questions are free in your browser with no sign-up, and the full Ball IQ app has thousands of football questions plus daily challenges and multiplayer.' },
    ],
  },
  {
    "slug": "zidane",
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you learn the story behind the moment, not just the result. Play the sample set below free in your browser, no sign-up. If it grabs you, the full Ball IQ app has thousands of questions plus daily challenges and multiplayer."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The sample set runs free in your browser with no sign-up. The full Ball IQ app adds thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. The sample set on this page is completely free to play in your browser with no sign-up and no download. If you want more, the full Ball IQ app has thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you finish the set knowing more than when you started. Play the sample set below free in your browser, no sign-up. And if it grips you, the full Ball IQ app has thousands of questions plus daily challenges and multiplayer."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The sample Pelé quiz runs free in your browser with no sign-up — just start answering. If you want more, the full Ball IQ app carries thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you learn the story behind the record rather than just ticking a box. Play the sample set below free in your browser, no sign-up. If you want more, the full Ball IQ app has thousands of questions plus daily challenges and multiplayer."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The sample set runs free in your browser with no sign-up. The full Ball IQ app goes further with thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. The sample set on this page is completely free and runs right in your browser — no sign-up, no download. It is a taster of the full Ball IQ app, which has thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you pick up the story behind the stat as you play. Play the sample set below free in your browser, no sign-up — and if you want the deep end, the full Ball IQ app has thousands of questions plus daily challenges and multiplayer."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The sample set on this page is completely free to play in your browser with no sign-up and no download. If you want more, the full Ball IQ app carries thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer modes to play against friends."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every question comes with a short explained answer, so you learn the story behind the fact — the context, the date, the why. Play the sample set below free in your browser, no sign-up. If you want the deep game, the full Ball IQ app has thousands of questions plus daily challenges and multiplayer to test yourself against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The sample set on this page is completely free and runs right in your browser with no sign-up or download. If you want more, the full Ball IQ app has thousands of questions across players, clubs and competitions, plus daily challenges and multiplayer."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with a short explanation, so you finish the quiz knowing more than when you started. It's completely free, runs right in your browser, and needs no sign-up. If it hooks you, the Ball IQ app goes deeper — over thousands of football questions, a daily football word game, and multiplayer modes where you can test your knowledge against friends in real time."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Johan Cruyff quiz is completely free and plays right in your browser with no sign-up required. If you want more, the Ball IQ app offers over thousands of football questions, a daily football word game, and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with an explanation, so you finish knowing more than you started — and it's completely free in your browser with no sign-up. If it leaves you wanting more, the Ball IQ app has thousands of football questions, a daily football word game, and multiplayer modes to test your knowledge against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes — it's completely free and runs right in your browser with no sign-up required. For more, the Ball IQ app carries thousands of football questions, a daily football word game, and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. The Lewandowski quiz is completely free and plays straight in your browser with no sign-up or download. If you want more, the Ball IQ app offers over thousands of football questions, a daily football word game, and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with a short explanation, so you finish the quiz knowing more than when you started — the year, the number, the context behind each one. It is completely free, runs right here in your browser, and needs no sign-up. If you enjoy it, Ball IQ has more than thousands of football questions across clubs, leagues and legends, a daily football word game, and multiplayer modes where you can put your knowledge up against friends. Salah is only the beginning."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Mohamed Salah quiz is completely free, plays directly in your browser, and needs no sign-up or download. If you want more, the full Ball IQ app has over thousands of football questions spanning clubs, leagues and legends, a daily football word game, and multiplayer modes to play against friends."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with an explanation, so you learn the story behind the stat as you play. It is completely free in your browser with no sign-up required. If you want more, the Ball IQ app has over thousands of football questions, a daily football word game, and multiplayer modes to test yourself against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Thierry Henry quiz is completely free to play in your browser with no sign-up required. For more, the Ball IQ app has over thousands of football questions across clubs, players and competitions, plus a daily word game and multiplayer."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with a short explanation, so you finish knowing more than when you started, and the whole thing is free to play right in your browser with no sign-up. If it leaves you wanting more, the Ball IQ app carries over thousands of football questions, a daily football word game, and multiplayer modes where you can put your knowledge up against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Wayne Rooney quiz is completely free and plays right in your browser with no sign-up and no download. If you want more, the Ball IQ app adds over thousands of football questions, a daily football word game and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "Yes. The Steven Gerrard quiz is completely free and runs right in your browser with no sign-up and no download. If you want to keep going, the Ball IQ app packs in over thousands of football questions, a daily football word game, and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with an explanation, so you finish knowing more than when you started. It is completely free, playable right here in your browser with no sign-up required. If you enjoy it, the Ball IQ app goes further — over thousands of football questions, a daily football word game, and multiplayer modes where you can test your knowledge against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Ronaldinho quiz is completely free and runs right in your browser with no sign-up or download needed. If you want more, the Ball IQ app offers over thousands of football questions, a daily football word game, and multiplayer modes to challenge your friends."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with an explanation, so you finish the quiz knowing more than when you started. It is completely free, plays right in your browser, and needs no sign-up. If you enjoy it, the Ball IQ app goes deeper still, with more than thousands of football questions, a daily football word game, and multiplayer modes where you can test your knowledge against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Neymar quiz is completely free, plays directly in your browser, and needs no sign-up or download. If you want more, the Ball IQ app has over thousands of football questions, a daily football word game, and multiplayer modes."
      },
      {
  ...
  },
  {
    ...
    "intro": [
      ...
      "Every answer comes with an explanation, so you finish knowing more than when you started — not just whether you were right. It is completely free, plays instantly in your browser, and needs no sign-up. If it sparks something, the Ball IQ app goes further: over thousands of football questions across clubs and competitions, a daily football word game, and multiplayer modes where you can test your knowledge head-to-head against friends."
    ],
    "faq": [
      {
      ...
      },
      {
        ...
        "a": "Yes. The Modrić quiz is completely free, runs in your browser, and needs no sign-up. If you want more, the Ball IQ app has over thousands of football questions, a daily word game, and multiplayer modes."
      },
      {
