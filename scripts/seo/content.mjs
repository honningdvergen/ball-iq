...
export const ABOUT = {
  ...
  description:
    'Ball IQ is an independent football quiz game with thousands of sourced questions and an explanation behind most answers. Learn what it is and who makes it.',
...
export const LISTICLES = [
  {
    ...
    faq: [
      ...
      { q: 'Where do the questions come from?', a: 'From the Ball IQ question bank — researched against sources and fact-checked, the same questions our players face in the app.' },
...
export const GAMES_PAGE = {
  ...
  faq: [
    ...
    { q: 'How is this different from other football games sites?', a: 'The questions are researched against sources and fact-checked rather than scraped, every answer comes with the reason it is the answer, and small clubs get the same depth as the giants.' },
  ],
};
