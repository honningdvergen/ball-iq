...
export const XI_MARKUP = `<div class="xi-num" id="num"></div>
...
.logo{font-weight:900;font-size:15px;letter-spacing:-.02em;text-decoration:none;color:var(--text)}
.logo span{color:var(--accent)}
.num{margin-left:auto;font:700 11px/1 ui-monospace,Menlo,monospace;letter-spacing:.12em;
  text-transform:uppercase;color:var(--t3)}
h1{font-size:clamp(21px,5.2vw,28px);line-height:1.12;margin:0 0 4px;letter-spacing:-.025em;font-weight:900}
.sub{margin:0 0 14px;color:var(--t2);font-size:14px}
...
.markings{position:absolute;inset:0;width:100%;height:100%;pointer-events:none}
...
.row{position:absolute;left:0;right:0;display:flex;justify-content:center;gap:2%;padding:0 3%;
  transform:translateY(-50%)}
.slot{flex:1 1 0;max-width:112px;min-width:0;display:flex;flex-direction:column;align-items:center;gap:3px}
.disc{position:relative;width:100%;aspect-ratio:1;max-width:62px;border-radius:50%;overflow:hidden;
  background:rgba(6,10,7,.55);border:2px solid rgba(255,255,255,.45);
  display:flex;align-items:center;justify-content:center;
  transition:border-color .2s,transform .2s,background .2s}
.disc .shirt{font:800 17px/1 ui-monospace,Menlo,monospace;color:rgba(255,255,255,.72)}
.slot.got .disc{border-color:var(--accent);background:radial-gradient(circle at 50% 28%,#22452a,#0c1a0f);
  transform:scale(1.04)}
.slot.shown .disc{border-color:var(--gold)}
.plate{font-size:10.5px;font-weight:700;text-align:center;line-height:1.15;
...
.plate:empty{background:none;padding:0;min-height:6px}
.pos{font:700 9px/1 ui-monospace,Menlo,monospace;letter-spacing:.08em;color:rgba(255,255,255,.5)}

/* controls */
.bar{display:flex;gap:8px;margin-top:14px}
#guess{flex:1;min-width:0;background:var(--s2);border:1px solid var(--border2);border-radius:12px;
  padding:13px 15px;color:var(--text);font-size:16px;font-family:inherit;outline:none}
#guess:focus{border-color:var(--accent)}
.btn{flex:0 0 auto;padding:0 20px;border:0;border-radius:12px;background:var(--accent);color:#06230C;
  font-weight:800;font-size:14px;font-family:inherit;cursor:pointer;min-height:44px}
.btn[disabled]{background:var(--s2);color:var(--t3);cursor:default}
.meta{display:flex;align-items:center;gap:10px;margin-top:10px;font-size:13px;color:var(--t2)}
.lives{display:flex;gap:4px;margin-left:auto}
.life{width:9px;height:9px;border-radius:50%;background:var(--accent)}
.life.gone{background:var(--s3)}
.misses{display:flex;flex-wrap:wrap;gap:6px;margin-top:10px}
.miss{font-size:12.5px;color:var(--t3);text-decoration:line-through;background:var(--s2);
  border-radius:7px;padding:3px 8px}
.done{margin-top:16px;padding:16px;border-radius:14px;background:var(--s1);
  border:1px solid var(--border);text-align:center}
.done h2{margin:0 0 4px;font-size:19px}
.done p{margin:0 0 12px;color:var(--t2);font-size:14px}
.shakeit{animation:sk .26s}
@keyframes sk{25%{transform:translateX(-5px)}75%{transform:translateX(5px)}}
.foot{margin-top:26px;padding-top:16px;border-top:1px solid var(--border);color:var(--t3);font-size:13px}
.foot a{color:var(--t2)}`;
