...
await page.screenshot({ path: OUT + '/prod-00-home.png' });
await page.locator('.todays-seven-secondary').filter({ hasText: /Daily 7/ }).first().click();
await page.waitForTimeout(1500);
await page.screenshot({ path: OUT + '/prod-01-daily-q1.png' });
await answerUntilResults('daily');
await page.screenshot({ path: OUT + '/prod-02-daily-results-top.png' });
await page.screenshot({ path: OUT + '/prod-03-daily-results-full.png', fullPage: true });
...
await page.screenshot({ path: OUT + '/prod-04-classic-results-top.png' });
await page.screenshot({ path: OUT + '/prod-05-classic-results-full.png', fullPage: true });
