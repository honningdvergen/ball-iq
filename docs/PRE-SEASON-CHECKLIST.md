...
|---|---|---|---|
| Retention reach | 5/C | ◀ ACTIVE | web-push ask at the post-solve moment (`1ad33b4`, Alex = subscriber #1) + streak-aware reminder body (`9d3855a`, verified against Alex's live row). bdb7915 — streak repair live (un-shielded break → same-day comeback via yesterday catch-up; server+guest verified). Remaining (structural, ride 1.6.2): home-screen widget · FCM Android push |
