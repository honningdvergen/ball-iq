...
| Onboarding | 7/B | ◀ ACTIVE | 2ca50e1/6597384/2e90cac — pre-boot LCP shell (LCP node is now static HTML; probe: LCP == FCP), Inter→display=optional (font-metrics LCP theft fixed), 30d650e — onboard-done-answered/skipped + first-game-started events. Remaining: cold-LCP re-baseline after CrUX catches up |
