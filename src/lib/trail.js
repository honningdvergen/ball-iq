...
export const TRAIL_PLAYERS = [
  ...
  { key: "MESSI", display: ["Lionel","Messi"], nat: "Argentina",
  ...
  { key: "KANE", display: ["Harry","Kane"], nat: "England",
  ...
  { key: "GEA", display: ["David de","Gea"], nat: "Spain",
    ...
    loans: [false,false,false] },
  { key: "DYBALA", display: ["Paulo","Dybala"], nat: "Argentina",
  ...
  { key: "BECKER", display: ["Alisson","Becker"], nat: "Brazil",
    ...
    loans: [false,false,false] },
  { key: "HAKIMI", display: ["Achraf","Hakimi"], nat: "Morocco",
  ...
  { key: "MAGUIRE", display: ["Harry","Maguire"], nat: "England",
  ...
  { key: "MUTO", display: ["Yoshinori","Muto"], nat: "Japan",
    ...
    loans: [false,false,false,true,false] },
  { key: "GAKPO", display: ["Cody","Gakpo"], nat: "Netherlands",
    clubs: ["Jong PSV","PSV","Liverpool"],
    loans: [false,false,false] },
  { key: "CAN", display: ["Emre","Can"], nat: "Germany",
  ...
  { key: "JONG", display: ["Frenkie de","Jong"], nat: "Netherlands",
    clubs: ["Jong Ajax","Ajax","Barcelona"],
    loans: [false,false,false] },
  { key: "AFELLAY", display: ["Ibrahim","Afellay"], nat: "Netherlands",
  ...
  { key: "STONES", display: ["John","Stones"], nat: "England",
    clubs: ["Barnsley","Everton","Man City","Inter Milan"],
    loans: [false,false,false,false] },
  { key: "VERRATTI", display: ["Marco","Verratti"], nat: "Italy",
