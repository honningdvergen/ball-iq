    ...
    <header className="fd-head">
      <div className="fd-w fd-head-in">
        ...
        <nav className={`fd-nav${menu ? ' is-open' : ''}`} aria-label="Sections">
          <a href="/#today">Today</a><a href="/#games">Games</a><a className={a('clubs')} href="/#clubs">Clubs</a><a className={a('quizzes')} href="/football-quiz/">Quizzes</a><a className={a('lists')} href="/lists/">Lists</a>
        </nav>
