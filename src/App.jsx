...
export const CLUB_PACK_TO_QB = {
  ...
  Watford: "Watford", QPR: "Queens Park Rangers",
  ...
  SaoPaulo: "São Paulo", Gremio: "Grêmio", Internacional: "Internacional", Cruzeiro: "Cruzeiro",
  ...
  Schalke: "Schalke 04", Hamburg: "Hamburger SV", Frankfurt: "Eintracht Frankfurt",
...
export const CLUB_LEAGUES = {
  ...
  Schalke: "germany", Hamburg: "germany", Frankfurt: "germany",
  ...
  SaoPaulo: "brazil", Gremio: "brazil", Internacional: "brazil", Cruzeiro: "brazil",
...
export const CLUB_ABBR = {
  ...
  // SCI, not INT — Inter Milan already holds INT, and this map has no duplicates.
  SaoPaulo: "SAO", Gremio: "GRE", Internacional: "SCI", Cruzeiro: "CRU",
  ...
  BayernMunich: "BAY", Dortmund: "BVB", Frankfurt: "SGE",
  PSG: "PSG", Ajax: "AJA",
...
const CLUB_SLUG_TO_PACK = {
  ...
  "watford": "Watford", "queens-park-rangers": "QPR", "eintracht-frankfurt": "Frankfurt",
  ...
  "sao-paulo": "SaoPaulo", "gremio": "Gremio", "internacional": "Internacional", "cruzeiro": "Cruzeiro",
...
export const CLUB_PACKS = {
  ...
  Independiente: {
    name: "Independiente", icon: "🔴", color: "#DA291C",
    questions: [],
  },
  Racing: {
    name: "Racing Club", icon: "🔵", color: "#6CAFE0",
    questions: [],
  },
  Leipzig: {
  ...
  SaoPaulo: {
    name: "São Paulo", icon: "🔴", color: "#FE0000",
    questions: [],
  },
  Gremio: {
    name: "Grêmio", icon: "🔵", color: "#0D80BF",
    questions: [],
  },
  Internacional: {
    name: "Internacional", icon: "🔴", color: "#E5050F",
    questions: [],
  },
  Cruzeiro: {
    name: "Cruzeiro", icon: "🔵", color: "#2F529E",
    questions: [],
  },
  Palmeiras: {
  ...
  Watford:     { name: "Watford",             icon: "🐝", color: "#F2E23A", questions: [] },
  QPR:         { name: "Queens Park Rangers", icon: "⭕", color: "#1D5BA4", questions: [] },
...
function AppInner() {
  ...
  const saveStats = useCallback((newResult) => {
    ...
    // ⚠️ SUPERSEDED 2026-09-09 — the arithmetic moved to recordAnswers() in
    // lib/ballIqCard.js, beside the model that reads it, where it is unit-
    // tested: difficulty-weighted accuracy (Alex: "61% on easy equals 61; 61%
    // at medium should be 10% more rewarding, hard 20%"), per-answer decay
    // 0.995, faces fed by club play, and a legacy record's lifetime top-up
    // materialised on the first scored write. Read that file's header.
    const catStats = recordAnswers(stats.catStats || {}, newResult.allAnswers || [], { c: stats.totalCorrect || 0, a: stats.totalAnswered || 0 });
    const updated = {
  ...
  // Local notifications → hooks/useLocalNotifications.js (E16, 2026-09-06):
  // the toggle, the reminder-window scheduling, the in-app prompt gate, the
  // permission reconcile and the midnight rollover.
  const { notifEnabled, setNotifEnabled, notifBlocked, notifTimerRef, handleToggleNotif, resultsRemindState, remindFromResults, maybePromptNotif } =
    useLocalNotifications({ user, dailyDone, loginStreak, showToast, initialStreakRef, webPushOn, handleToggleWebPush });
