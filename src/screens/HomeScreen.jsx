    ...
    <div className="screen tab-content home-screen">
      ...
      <div className="home-app-banner">
        ...
        <div className="hab-actions">
          <a className="hab-store" href="https://apps.apple.com/us/app/ball-iq-football-trivia/id6775975961" target="_blank" rel="noopener" aria-label="Download on the App Store">
